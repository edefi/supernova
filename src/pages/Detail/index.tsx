        ...
        <div className="detail-box">
          <div className="p50">
            ...
            <div className="detail-sub flex items-center">
              ...
              <span className="spliteline flex items-center">
                <span className="label-1 text-gray-1">
                  {t("Platform token")}
                </span>
            ...
            <div className="detail-sub flex">
              <span>
                <span className="label-1 e text-gray-2">
                  {t("Genesis date")}
                </span>
          ...
          <div className="mt-10 grid gap-5 p50 mb-10">
            <div className="flex mb-10">
              <div className="mr-10 flex items-center ">
                ...
                <span className="mr-2 label-1 e flex">
                  {t("Twitter Heat")}:
                </span>
                <span className="flex gap-0.5 badge">
                  <img src={heat_active} />
                  <img src={heat_active} />
                  <img src={heat_active} />
                  <img src={heat_active} />
            ...
            <div className="data items-center leading-none">
              <div className="mr-4 label-1 e" style={{ marginBottom: 5 }}>
                {t("Twitter Sentiment Data")}
              </div>
              <a className="" href="/">
